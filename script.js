	...
	function dragged(d) {
		...
		vis.selectAll(".line")
		  .filter(function (dl, di) {
   		  ...
   		  .attr("x1", function(dl) { return nodes[dl.source].x; })
		  .attr("y1", function(dl) { return nodes[dl.source].y; })
		  .attr("x2", function(dl) { return nodes[dl.target].x; })
		  .attr("y2", function(dl) { return nodes[dl.target].y; });
